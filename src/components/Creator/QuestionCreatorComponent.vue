...
export default {
  name: "QuestionCreatorComponent",
  components: { ElForm, ElFormItem, ElInput, ElCol, ElRow, ElCheckbox },
  data() {
    return {
      questionTitle: "",
      answer1: {
